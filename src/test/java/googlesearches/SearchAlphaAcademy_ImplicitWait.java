...
public class SearchAlphaAcademy_ImplicitWait {
    ...
    public void resultFound_when_SearchTermProvided_onBing() {
        ...
        //Agree to consent
        WebElement consentButton = driver.findElement(By.xpath("//button[@id='bnp_btn_accept']"));
        consentButton.click();
        ...
        Assertions.assertTrue(firstResult.getText().contains(searchResult), errorMessage);
    }
