...
public class SearchAlphaAcademy_ExplicitWait_DiffBrowsers {
    ...
    public void resultFound_when_SearchTermProvided_onBing() {
        ...
        //Assert result found
        WebElement firstResult = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ol[@id='b_results']/li[1]//h2/a[contains(., '" + searchText + "')]")));
    ...
    public void resultFound_when_SearchTermProvided_onGoogle() {
        ...
        //Click search button
        WebElement searchButton = wait.until(ExpectedConditions.visibilityOf(
                driver.findElement(By.xpath("(//input[@type='submit' and @name='btnK'])[1]"))));
        searchButton.click();
